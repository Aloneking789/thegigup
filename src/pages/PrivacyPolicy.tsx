    ...
    <div className="w-full max-w-6xl mx-auto">
      <Card className="shadow-xl border-0 mt-8">
        <CardHeader className="text-center pb-4">
          <CardTitle className="text-3xl font-bold text-gray-800">Privacy Policy</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-gray-700 text-lg">
          <h2 className="text-xl font-semibold mb-2">1. Information We Collect</h2>
          <p>
            We collect personal information such as your name, email address, and payment details when you register or use TheGigUp. We may also collect information about your usage of the platform.
          </p>
          ...
          <p>
            <Link to="/terms" className="text-blue-600 hover:text-blue-500">Read our Terms of Service</Link>
          </p>
        </CardContent>
      </Card>
    </div>
